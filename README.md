...
Component States is a method of defining various different visual formats for a single component

3. Describe props.

Props are data that flows from one to another component as a parameters

4. What are side effects, and how do you sync effects in a React component to changes of certain state or props?

Side effects are  anything that affects something outside of the scope of the current function that's being executed.Whenever props change, we will set the state inside useEffect.